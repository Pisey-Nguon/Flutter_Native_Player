...
public class DemoDownloadService extends DownloadService {
  ...
  protected com.google.android.exoplayer2.offline.DownloadManager getDownloadManager() {
    ...
    com.google.android.exoplayer2.offline.DownloadManager downloadManager = DemoUtil.getDownloadManager(/* context= */ this);
  ...
  protected Notification getForegroundNotification(@NonNull List<Download> downloads) {
    BroadcastSender.sendBroadcastPercentage(this,downloads);
   ...
   */
  private static final class TerminalStateNotificationHelper implements com.google.android.exoplayer2.offline.DownloadManager.Listener {
    ...
    @Override
    public void onDownloadChanged(com.google.android.exoplayer2.offline.DownloadManager downloadManager, Download download, @Nullable Exception finalException) {
      ...
      switch (download.state) {
        case Download.STATE_COMPLETED:
          ...
          BroadcastSender.sendBroadcastStatusDownload(context, ConstantDownload.DOWNLOAD_COMPLETED);
          break;
        case Download.STATE_FAILED:
          notification = notificationHelper.buildDownloadFailedNotification(
                  ...
                  /* contentIntent= */ null,
                  Util.fromUtf8Bytes(download.request.data));
          BroadcastSender.sendBroadcastStatusDownload(context, ConstantDownload.DOWNLOAD_FAILED);
          break;
        case Download.STATE_DOWNLOADING:
          BroadcastSender.sendBroadcastStatusDownload(context,ConstantDownload.DOWNLOAD_STARTED);
          break;
        case Download.STATE_QUEUED:
          break;
        case Download.STATE_REMOVING:
          BroadcastSender.sendBroadcastStatusDownload(context,ConstantDownload.DOWNLOAD_CANCELED);
          break;
