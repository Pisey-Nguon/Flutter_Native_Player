...
class PlayerOverlayController extends StatelessWidget{
  ...
  const PlayerOverlayController({Key? key,required this.controller,required this.playerMethodManager, this.progressColors,required this.width,required this.height}) : super(key: key);
  @override
